...
class Formulario {
	...
	camposToJSON() {
		let contacto = {}
			...
			contacto["edad"] = `${this.esMayor() ? "Mayor" : "Menor"} de edad`
		return contacto
	}
...
function save_data() {
	let myForm = new Formulario(inputs[0].value, inputs[1].value, inputs[2].value, inputs[3].value, inputs[4].value, inputs[5].value);
